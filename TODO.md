...
6. ~~**Preisach-style hysteresis activation for nanomagnet modeling**~~ — Removed. Hysteresis is instead modeled implicitly via self-connections (rate-dependent) and high spectral radius driving bistability (rate-independent).
